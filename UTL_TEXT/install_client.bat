...
echo @install_scripts/grant_client_access.sql %RemoteUser% | sqlplus %InstallUser%/%PWD%@%SID% 

echo @install_scripts/create_client_synonyms.sql | sqlplus %RemoteUser%/%RemotePWD%@%SID% 
